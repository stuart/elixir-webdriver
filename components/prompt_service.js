...
function DrivenPromptService() {
    ...
    for(var e = 0;e < b.length;e++) {
      ...
      if(f && (f = f.getService())) {
        try {
          ...
          fxdriver.logging.info("Found implementation at: " + b[e]);
          return g
        }catch(h) {
        }
      }
  ...
  b || fxdriver.logging.info("Unable to locate original prompt service");
  a || fxdriver.logging.info("Unable to locate original prompter");
